    ...
    <div id="header-carousel" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active" style="height: 410px;">
          <img class="img-fluid" src="assets/carousel-1.jpg" alt="Image">
        ...
        <div class="carousel-item" style="height: 410px;">
          <img class="img-fluid" src="assets/carousel-3.jpeg" alt="Image">
          <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
            <div class="p-3" style="max-width: 700px;">
              <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order</h4>
      ...
      <div class="col-lg-4 col-md-6 pb-1">
        <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
          ...
          <a href="" class="cat-img position-relative overflow-hidden mb-3">
            <img class="img-fluid" src="assets/cat-1.jpg" alt="">
          </a>
        ...
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                <p class="text-right">15 Products</p>
                <a href="" class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid" src="assets/cat-2.jpg" alt="">
                </a>
        ...
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                <p class="text-right">15 Products</p>
                <a href="" class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid" src="assets/cat-3.jpg" alt="">
                </a>
        ...
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                <p class="text-right">15 Products</p>
                <a href="" class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid" src="assets/cat-4.jpg" alt="">
                </a>
        ...
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                <p class="text-right">15 Products</p>
                <a href="" class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid" src="assets/cat-5.jpg" alt="">
                </a>
        ...
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                <p class="text-right">15 Products</p>
                <a href="" class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid" src="assets/cat-6.jpg" alt="">
                </a>
          ...
          <div class="col">
              <div class="owl-carousel vendor-carousel">
                  <div class="vendor-item border p-4">
                      <img src="assets/vendor-1.jpg" alt="">
                  </div>
                  <div class="vendor-item border p-4">
                      <img src="assets/vendor-2.jpg" alt="">
                  </div>
                  <div class="vendor-item border p-4">
                      <img src="assets/vendor-3.jpg" alt="">
                  </div>
                  <div class="vendor-item border p-4">
                      <img src="assets/vendor-4.jpg" alt="">
                  </div>
                  <div class="vendor-item border p-4">
                      <img src="assets/vendor-5.jpg" alt="">
                  </div>
                  <div class="vendor-item border p-4">
                      <img src="assets/vendor-6.jpg" alt="">
                  </div>
                  <div class="vendor-item border p-4">
                      <img src="assets/vendor-7.jpg" alt="">
                  </div>
                  <div class="vendor-item border p-4">
                      <img src="assets/vendor-8.jpg" alt="">
                  </div>
              </div>
          </div>
      </div>
